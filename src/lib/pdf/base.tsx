...
export const styles = StyleSheet.create({
  ...
  bizName: { fontFamily: "Fraunces", fontSize: 16, color: C.ink },
  bizMeta: { fontSize: 8, color: C.muted, marginTop: 1 },
  docWord: { fontFamily: "Fraunces", fontSize: 20, color: C.accent600, textAlign: "right" },
  docNum: { fontSize: 10, color: C.ink500, marginTop: 2, textAlign: "right" },
